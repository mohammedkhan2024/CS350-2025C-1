            ...
            for word in wordList:
                ...
                for char in word:
                    ...
                    for x in morse:
                        ...
                        ## To determine if the next symbol is a dot or a 
                        ## dash and transition
                        ...
                        ## To determine if there is another symbol in the message. 
                        ## If so transition the state machine to the appropriate 
                    ...
                    ## To determine if there is another letter in the message. 
                    ## If so transition the state machine to the appropriate 
                ...
                ## To determine if there is another word in the message. 
                ## If so transition the state machine to the appropriate 
...
## To assign the appropriate function to the greenButton variable 
